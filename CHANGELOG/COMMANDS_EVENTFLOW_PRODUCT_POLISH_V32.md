...
PATCH_ZIP="$HOME/Downloads/EventFlow_Product_Polish_v32_patch.zip"
DESKTOP="$HOME/Desktop"
PROJECT_DIR="$DESKTOP/EventFlow"
PATCH_DIR="/tmp/eventflow_patch_v32"
...
git checkout -b local/product-polish-v32

# Komendy wdrożenia V10

Zakładany plik:

```bash
~/Downloads/EventFlow_Product_Polish_v10_patch.zip
```
...
PATCH_ZIP="$HOME/Downloads/EventFlow_Product_Polish_v10_patch.zip"
DESKTOP="$HOME/Desktop"
PROJECT_DIR="$DESKTOP/EventFlow"
PATCH_DIR="/tmp/eventflow_patch_v10"
...
cd "$PROJECT_DIR"
git checkout -b local/product-polish-v10

# Komendy wdrożenia V30

```bash
set -e

PATCH_ZIP="$HOME/Downloads/EventFlow_Product_Polish_v30_patch.zip"
DESKTOP="$HOME/Desktop"
PROJECT_DIR="$DESKTOP/EventFlow"
PATCH_DIR="/tmp/eventflow_patch_v30"
...
git checkout -b local/product-polish-v30

# Komendy EventFlow V29

```bash
set -e

PATCH_ZIP="$HOME/Downloads/EventFlow_Product_Polish_v29_patch.zip"
DESKTOP="$HOME/Desktop"
PROJECT_DIR="$DESKTOP/EventFlow"
PATCH_DIR="/tmp/eventflow_patch_v29"
...
git checkout -b local/product-polish-v29

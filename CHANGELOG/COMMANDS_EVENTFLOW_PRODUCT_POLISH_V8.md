# Komendy wdrożenia V8

Zakładam, że patch ZIP jest w `~/Downloads/EventFlow_Product_Polish_v8_patch.zip`.

```bash
set -e
PATCH_ZIP="$HOME/Downloads/EventFlow_Product_Polish_v8_patch.zip"
DESKTOP="$HOME/Desktop"
PROJECT_DIR="$DESKTOP/EventFlow"
PATCH_DIR="/tmp/eventflow_patch_v8"
...
cd "$PROJECT_DIR"
git checkout -b local/product-polish-v8

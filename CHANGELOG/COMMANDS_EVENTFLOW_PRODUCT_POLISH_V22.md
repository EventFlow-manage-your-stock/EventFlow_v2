# Komendy wdrożeniowe EventFlow V22

```bash
set -e

PATCH_ZIP="$HOME/Downloads/EventFlow_Product_Polish_v22_patch.zip"
DESKTOP="$HOME/Desktop"
PROJECT_DIR="$DESKTOP/EventFlow"
PATCH_DIR="/tmp/eventflow_patch_v22"
...
git checkout -b local/product-polish-v22

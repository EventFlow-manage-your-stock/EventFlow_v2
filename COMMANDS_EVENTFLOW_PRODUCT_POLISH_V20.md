# Komendy — EventFlow Product Polish V20

```bash
set -e

PATCH_ZIP="$HOME/Downloads/EventFlow_Product_Polish_v20_patch.zip"
DESKTOP="$HOME/Desktop"
PROJECT_DIR="$DESKTOP/EventFlow"
PATCH_DIR="/tmp/eventflow_patch_v20"
...
git checkout -b local/product-polish-v20

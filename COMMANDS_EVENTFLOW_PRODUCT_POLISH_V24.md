...
Pobierz ZIP do `~/Downloads`, potem:

```bash
set -e

PATCH_ZIP="$HOME/Downloads/EventFlow_Product_Polish_v24_patch.zip"
DESKTOP="$HOME/Desktop"
PROJECT_DIR="$DESKTOP/EventFlow"
PATCH_DIR="/tmp/eventflow_patch_v24"
...
git checkout -b local/product-polish-v24

# Komendy wdrożeniowe — EventFlow V16

Zakładamy, że patch ZIP jest w `~/Downloads/EventFlow_Product_Polish_v16_patch.zip`.

```bash
set -e

PATCH_ZIP="$HOME/Downloads/EventFlow_Product_Polish_v16_patch.zip"
DESKTOP="$HOME/Desktop"
PROJECT_DIR="$DESKTOP/EventFlow"
PATCH_DIR="/tmp/eventflow_patch_v16"
...
git checkout -b local/product-polish-v16
